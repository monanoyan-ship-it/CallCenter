...
public class QualityChecklistDetailDto : QualityChecklistDto
{
    public bool HideGroupNames { get; set; }
    public List<QualityQuestionDto> Questions { get; set; } = new();
}
...
public class QualityQuestionDto
{
    ...
    public bool IsActive { get; set; }
    public List<QualitySubCriteriaDto> SubCriteria { get; set; } = new();
}
...
public class QualitySubCriteriaDto
{
    public int Id { get; set; }
...
public class QualityEvaluationDetailDto : QualityEvaluationDto
{
    public string? EvaluationComment { get; set; }
    public string? Notes { get; set; }
    public DateTime? StartedAt { get; set; }
    public DateTime? FormOpenedAt { get; set; }
    public List<QualityAnswerDto> Answers { get; set; } = new();
}
...
public class QualityScoreThresholdDto
{
    public int Id { get; set; }
...
public class QualityDashboardDto
{
    ...
    public List<QualityAgentScoreDto> TopAgents { get; set; } = new();
    public List<QualityAgentScoreDto> BottomAgents { get; set; } = new();
}

public class QualityAgentScoreDto
{
