...
/// </summary>
public class CrmQualityEvaluation
{
    ...
    /// <summary>
    /// Değerlendirme durumu (CrmQualityEvaluationStatuses.Ids)
    /// Pending=1, InProgress=2, Completed=3, Draft=4, Cancelled=5
    /// </summary>
    public int StatusId { get; set; } = Enums.CrmQualityEvaluationStatuses.Ids.Pending;
