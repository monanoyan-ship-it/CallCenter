...
/// </summary>
public class QualityAnswer
{
    public int Id { get; set; }

    /// <summary>Hangi değerlendirmeye ait</summary>
    public int EvaluationId { get; set; }
    public QualityEvaluation Evaluation { get; set; } = null!;
    ...
    /// <summary>
    /// Uygulanan ceza tipi (QualityPenaltyTypes.Ids)
    /// None=0, YellowCard=1, RedCard=2
    /// </summary>
    public int AppliedPenaltyTypeId { get; set; } = Enums.QualityPenaltyTypes.Ids.None;
    ...
    public ICollection<QualityAnswerSubCriteriaSelection> SubCriteriaSelections { get; set; } = new List<QualityAnswerSubCriteriaSelection>();
}
