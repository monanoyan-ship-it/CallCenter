...
/// </summary>
public class CrmQualityChecklist
{
    ...
    /// <summary>
    /// Puanlama yöntemi (CrmQualityScoringMethods.Ids)
    /// Maximum: (GivenPoints / MaxPoints) * WeightPoints
    /// CriteriaTotal: Seçenek puanı direkt sayılır
    /// </summary>
    public int ScoringMethodId { get; set; } = Enums.CrmQualityScoringMethods.Ids.Maximum;
    ...
    // Navigation
    public ICollection<CrmQualityQuestion> Questions { get; set; } = new List<CrmQualityQuestion>();
    public ICollection<CrmQualityEvaluation> Evaluations { get; set; } = new List<CrmQualityEvaluation>();
}
