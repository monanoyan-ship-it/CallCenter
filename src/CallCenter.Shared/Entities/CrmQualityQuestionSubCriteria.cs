...
/// </summary>
public class CrmQualityQuestionSubCriteria
{
    ...
    // Navigation
    public ICollection<CrmQualityAnswerSubCriteriaSelection> Selections { get; set; } = new List<CrmQualityAnswerSubCriteriaSelection>();
}
