...
/// </summary>
public class CrmQualityQuestion
{
    public int Id { get; set; }

    /// <summary>Hangi checklist'e ait</summary>
    public int ChecklistId { get; set; }
    public CrmQualityChecklist Checklist { get; set; } = null!;
    ...
    /// <summary>
    /// Puanlama tipi (CrmQualityScoringTypes.Ids)
    /// Scored=1: Normal puanlama
    /// Unscored=2: Puansız (sadece gözlem)
    /// Penalty=3: Ceza (sarı/kırmızı kart)
    /// </summary>
    public int ScoringTypeId { get; set; } = Enums.CrmQualityScoringTypes.Ids.Scored;
    ...
    /// <summary>
    /// Ceza tipi (CrmQualityPenaltyTypes.Ids) - ScoringType=Penalty olduğunda kullanılır
    /// None=0, YellowCard=1, RedCard=2
    /// </summary>
    public int PenaltyTypeId { get; set; } = Enums.CrmQualityPenaltyTypes.Ids.None;
    ...
    // Navigation
    public ICollection<CrmQualityAnswer> Answers { get; set; } = new List<CrmQualityAnswer>();
    public ICollection<CrmQualityQuestionSubCriteria> SubCriteria { get; set; } = new List<CrmQualityQuestionSubCriteria>();
}
