...
public static class SalonRoles
{
    ...
    public static readonly TypeItem Manager = new(102, "Manager", "SalonRole.Manager", "Mudur", "bi-person-badge", "bg-warning text-dark", 2);
    public static readonly TypeItem Hairdresser = new(103, "Hairdresser", "SalonRole.Hairdresser", "Kuafor", "bi-scissors", "bg-primary", 3, isDefault: true);
    public static readonly TypeItem Beautician = new(104, "Beautician", "SalonRole.Beautician", "Guzellik Uzmani", "bi-stars", "bg-pink", 4);
