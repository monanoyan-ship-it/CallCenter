...
public static class SalonPortalModules
{
    ...
    public static readonly TypeItem SlnExpenses = new(208, "SlnExpenses", "SalonModule.Expenses", "Masraf Takibi", "bi-credit-card", "bg-dark", 8, isDefault: true);
    ...
    public static readonly TypeItem SlnSuppliers = new(210, "SlnSuppliers", "SalonModule.Suppliers", "Tedarikçi ve Cari", "bi-truck", "bg-teal", 10, isDefault: true);
