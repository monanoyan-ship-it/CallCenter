...
{
    public static readonly TypeItem Open = new(1, "Open", "Ticket.Open", "Açık", "bi-circle-fill", "bg-warning text-dark", 1, isDefault: true);
    ...
    public static readonly TypeItem Resolved = new(4, "Resolved", "Ticket.Resolved", "Çözüldü", "bi-check-circle-fill", "bg-success", 4);
    public static readonly TypeItem Closed = new(5, "Closed", "Ticket.Closed", "Kapandı", "bi-x-circle-fill", "bg-dark", 5);
...
{
    public static readonly TypeItem Low = new(1, "Low", "Ticket.Low", "Düşük", "bi-arrow-down", "bg-secondary", 1);
    public static readonly TypeItem Medium = new(2, "Medium", "Ticket.Medium", "Orta", "bi-dash", "bg-info", 2, isDefault: true);
    public static readonly TypeItem High = new(3, "High", "Ticket.High", "Yüksek", "bi-arrow-up", "bg-warning text-dark", 3);
...
public static class DealStages
{
    ...
    public static readonly TypeItem Negotiation = new(4, "Negotiation", "Deal.Negotiation", "Müzakere", "bi-chat-dots-fill", "bg-warning text-dark", 4);
    public static readonly TypeItem Won = new(5, "Won", "Deal.Won", "Kazanıldı", "bi-trophy-fill", "bg-success", 5);
...
public static class ActivityTypes
{
    ...
    public static readonly TypeItem Meeting = new(3, "Meeting", "Activity.Meeting", "Toplantı", "bi-camera-video-fill", "bg-success", 3);
    public static readonly TypeItem Note = new(4, "Note", "Activity.Note", "Not", "bi-sticky-fill", "bg-warning text-dark", 4);
    public static readonly TypeItem Task = new(5, "Task", "Activity.Task", "Görev", "bi-check2-square", "bg-secondary", 5);
...
{
    public static readonly TypeItem CSAT = new(1, "CSAT", "Survey.CSAT", "Müşteri Memnuniyeti", "bi-emoji-smile-fill", "bg-success", 1, isDefault: true);
    public static readonly TypeItem NPS = new(2, "NPS", "Survey.NPS", "Net Promoter Score", "bi-graph-up-arrow", "bg-primary", 2);
    public static readonly TypeItem Custom = new(3, "Custom", "Survey.Custom", "Özel Anket", "bi-card-checklist", "bg-info", 3);
...
public static class SurveyQuestionTypes
{
    ...
    public static readonly TypeItem MultiChoice = new(2, "MultiChoice", "SurveyQ.MultiChoice", "Çoktan Seçmeli", "bi-list-check", "bg-info", 2);
    public static readonly TypeItem Text = new(3, "Text", "SurveyQ.Text", "Serbest Metin", "bi-chat-left-text-fill", "bg-secondary", 3);
    public static readonly TypeItem YesNo = new(4, "YesNo", "SurveyQ.YesNo", "Evet/Hayır", "bi-toggle-on", "bg-primary", 4);
...
{
    public static readonly TypeItem Todo = new(1, "Todo", "CrmTask.Todo", "Yapılacak", "bi-circle", "bg-secondary", 1, isDefault: true);
    public static readonly TypeItem InProgress = new(2, "InProgress", "CrmTask.InProgress", "Devam Ediyor", "bi-arrow-repeat", "bg-info", 2);
    public static readonly TypeItem Done = new(3, "Done", "CrmTask.Done", "Tamamlandı", "bi-check-circle-fill", "bg-success", 3);
    public static readonly TypeItem Cancelled = new(4, "Cancelled", "CrmTask.Cancelled", "İptal", "bi-x-circle-fill", "bg-danger", 4);
