...
public static class ModuleRequestStatuses
{
    ...
    public static readonly TypeItem Approved = new(2, "Approved", "ModuleRequestStatus.Approved", "Onaylandi", "bi-check-circle", "bg-success", 2);
    public static readonly TypeItem Rejected = new(3, "Rejected", "ModuleRequestStatus.Rejected", "Reddedildi", "bi-x-circle", "bg-danger", 3);
    public static readonly TypeItem Cancelled = new(4, "Cancelled", "ModuleRequestStatus.Cancelled", "Iptal edildi", "bi-slash-circle", "bg-secondary", 4);
