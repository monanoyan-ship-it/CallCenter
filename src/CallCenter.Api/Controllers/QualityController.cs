...
[Authorize]
public class QualityController : AuditableControllerBase
{
    private readonly IQualityFactory _qualityFactory;

    public QualityController(IAuditFactory auditFactory, IQualityFactory qualityFactory)
        : base(auditFactory)
    {
    ...
    public async Task<IActionResult> CreateChecklist([FromBody] CreateChecklistRequest req)
    {
        ...
        await AuditCrudAsync("Create", "QualityChecklist", result.Uid.ToString(),
    ...
    public async Task<IActionResult> UpdateChecklist(Guid uid, [FromBody] UpdateChecklistRequest req)
    {
        ...
        await AuditCrudAsync("Update", "QualityChecklist", uid.ToString(),
    ...
    public async Task<IActionResult> DeleteChecklist(Guid uid)
    {
        ...
        await AuditCrudAsync("Delete", "QualityChecklist", uid.ToString(),
    ...
    public async Task<IActionResult> CreateEvaluation([FromBody] CreateEvaluationRequest req)
    {
        ...
        await AuditCrudAsync("Create", "QualityEvaluation", evaluation!.Uid.ToString(),
    ...
    public async Task<IActionResult> SubmitEvaluation(Guid uid, [FromBody] SubmitEvaluationRequest req)
    {
        ...
        await AuditCrudAsync("Update", "QualityEvaluation", uid.ToString(),
