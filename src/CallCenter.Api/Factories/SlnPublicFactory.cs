...
public class SlnPublicFactory : ISlnPublicFactory
{
    ...
    public async Task<SlnSalonProfileDto?> GetBySlugAsync(string slug)
    {
        ...
        return new SlnSalonProfileDto
        {
            ...
            LogoUrl = branch != null ? branch.PhotoUrl : profile?.LogoUrl,
            CoverImageUrl = branch != null ? branch.CoverImageUrl : profile?.CoverImageUrl,
            FaviconUrl = profile?.FaviconUrl,
            GalleryImagesJson = branch != null ? branch.GalleryImagesJson : profile?.GalleryImagesJson,
