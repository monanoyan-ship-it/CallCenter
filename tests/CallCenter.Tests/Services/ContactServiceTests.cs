...
public class ContactServiceTests : IDisposable
{
    ...
    public ContactServiceTests()
    {
        ...
        _sut = new ContactService(_db, NullLogger<ContactService>.Instance);
    }
    ...
    public async Task CreateContact_ValidRequest_CreatesAndReturns()
    {
        ...
        result.SourceId.Should().Be(ContactSources.Ids.Manual);
    }
    ...
    public async Task GetContacts_ReturnsOwnedAndSharedContacts()
    {
        ...
        _db.Contacts.AddRange(
            new Contact { FullName = "Kisi 1", PhoneNumber = "1111", OwnerUserId = 101, CustomerId = 200 },
            new Contact { FullName = "Kisi 2", PhoneNumber = "2222", OwnerUserId = null, CustomerId = 200 }, // paylasilmis
            new Contact { FullName = "Kisi 3", PhoneNumber = "3333", OwnerUserId = 102, CustomerId = 200 }  // baskasinin
        );
    ...
    {
        _db.Contacts.AddRange(
            new Contact { FullName = "Ali Veli", PhoneNumber = "1111", OwnerUserId = 101 },
            new Contact { FullName = "Mehmet Can", PhoneNumber = "2222", OwnerUserId = 101 },
            new Contact { FullName = "Ayse Demir", PhoneNumber = "3333", OwnerUserId = 101, Company = "Ali Ticaret" }
        );
        await _db.SaveChangesAsync();
    ...
    {
        var contact = new Contact { FullName = "Test", PhoneNumber = "1234", OwnerUserId = 101 };
    ...
    {
        var contact = new Contact { FullName = "Gizli", PhoneNumber = "9999", OwnerUserId = 102 };
        _db.Contacts.Add(contact);
        await _db.SaveChangesAsync();
    ...
    {
        var contact = new Contact { FullName = "Ortak", PhoneNumber = "5555", OwnerUserId = null };
        _db.Contacts.Add(contact);
        await _db.SaveChangesAsync();
    ...
    public async Task ImportCsv_ValidData_ImportsCorrectly()
    {
        ...
        var contacts = _db.Contacts.Where(c => c.OwnerUserId == 101).ToList();
