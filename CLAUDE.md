...
Birden fazla Claude/Codex oturumu ayni anda calisabilir. Cakismayi onlemek icin:
...
Birden fazla oturum ayni repo uzerinde calisirken her oturum kendi degisiklik alanindan sorumludur.
- Kod degisikligi yapan oturum kendi diff'ini kontrol eder ve build/test durumunu raporlar.
- Test/deploy yapan oturum kodu izinsiz refactor etmez; buldugu hatayi kullaniciya net ozetler.
- Ayni dosyaya paralel degisiklik gerekiyorsa once kullanicidan yonlendirme alinir.
- Ne Claude ne Codex kullanici acikca soylemeden commit/push yapar.
